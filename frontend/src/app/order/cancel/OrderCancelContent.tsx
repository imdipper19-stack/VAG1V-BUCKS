...
export default function OrderCancelContent() {
  ...
  return (
    <main className="min-h-screen bg-[#050507] text-[#f7f5ff] flex items-center justify-center p-6">
      <div className="fixed inset-0 pointer-events-none bg-[radial-gradient(circle_at_50%_8%,rgba(239,68,68,0.08),transparent_40%),linear-gradient(180deg,#07070a_0%,#050507_52%,#08070c_100%)]" />
      ...
      <div className="relative z-10 w-full max-w-md text-center">
        ...
        <p className="text-[#aaa5b9] text-sm leading-7 mb-8">
          Вы отменили оплату или она не прошла. Заказ сохранён — вы можете попробовать снова или выбрать другой пакет.
        </p>
        ...
        <div className="flex flex-col gap-3">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="block w-full rounded-2xl border border-white/10 bg-white/[.026] px-5 py-4 text-sm font-bold text-[#aaa5b9] transition hover:text-white text-center"
          >
